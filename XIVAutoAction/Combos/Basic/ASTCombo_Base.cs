...
internal abstract class ASTCombo_Base<TCmd> : CustomCombo<TCmd> where TCmd : Enum
{
    ...
    /// 生辰
    /// </summary>
    public static BaseAction Ascend { get; } = new(ActionID.Ascend, true,isTimeline: true);

    /// <summary>
    /// 凶星
    /// </summary>
    public static BaseAction Malefic { get; } = new(ActionID.Malefic, isTimeline: true);

    /// <summary>
    /// 烧灼
    /// </summary>
    public static BaseAction Combust { get; } = new(ActionID.Combust, isEot: true, isTimeline: true)
    {
    ...
    /// 重力    
    /// </summary>
    public static BaseAction Gravity { get; } = new(ActionID.Gravity, isTimeline: true);
    ...
    /// 光速
    /// </summary>
    public static BaseAction Lightspeed { get; } = new(ActionID.Lightspeed, isTimeline: true);
    ...
    /// 星力
    /// </summary>
    public static BaseAction Astrodyne { get; } = new(ActionID.Astrodyne, isTimeline: true)
    {
        ActionCheck = b =>
        {
    ...
    /// 占卜
    /// </summary>
    public static BaseAction Divination { get; } = new(ActionID.Divination, true, isTimeline: true);

    /// <summary>
    /// 抽卡
    /// </summary>
    public static BaseAction Draw { get; } = new(ActionID.Draw, isTimeline: true)
    {
    ...
    /// 重抽
    /// </summary>
    public static BaseAction Redraw { get; } = new(ActionID.Redraw, isTimeline: true)
    {
    ...
    /// 小奥秘卡
    /// </summary>
    public static BaseAction MinorArcana { get; } = new(ActionID.MinorArcana, isTimeline: true)
    {
    ...
    /// 出王冠卡
    /// </summary>
    public static BaseAction CrownPlay { get; } = new(ActionID.CrownPlay, isTimeline: true)
    {
    ...
    /// 太阳神之衡
    /// </summary>
    private static BaseAction Balance { get; } = new(ActionID.Balance, isTimeline: true)
    {
    ...
    /// 放浪神之箭
    /// </summary>
    private static BaseAction Arrow { get; } = new(ActionID.Arrow, isTimeline: true)
    {
        ChoiceTarget = TargetFilter.ASTMeleeTarget,
    ...
    /// 战争神之枪
    /// </summary>
    private static BaseAction Spear { get; } = new(ActionID.Spear, isTimeline: true)
    {
        ChoiceTarget = TargetFilter.ASTMeleeTarget,
    ...
    /// 世界树之干
    /// </summary>
    private static BaseAction Bole { get; } = new(ActionID.Bole, isTimeline: true)
    {
    ...
    /// 河流神之瓶
    /// </summary>
    private static BaseAction Ewer { get; } = new(ActionID.Ewer, isTimeline: true)
    {
        ChoiceTarget = TargetFilter.ASTRangeTarget,
    ...
    /// 建筑神之塔
    /// </summary>
    private static BaseAction Spire { get; } = new(ActionID.Spire, isTimeline: true)
    {
        ChoiceTarget = TargetFilter.ASTRangeTarget,
