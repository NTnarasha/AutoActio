...
internal abstract class DRKCombo_Base<TCmd> : CustomCombo<TCmd> where TCmd : Enum
{
    ...
    /// 重斩
    /// </summary>
    public static BaseAction HardSlash { get; } = new(ActionID.HardSlash, isTimeline: true);

    /// <summary>
    /// 吸收斩
    /// </summary>
    public static BaseAction SyphonStrike { get; } = new(ActionID.SyphonStrike, isTimeline: true);

    /// <summary>
    /// 释放
    /// </summary>
    public static BaseAction Unleash { get; } = new(ActionID.Unleash, isTimeline: true);

    /// <summary>
    /// 深恶痛绝
    /// </summary>
    public static BaseAction Grit { get; } = new(ActionID.Grit, shouldEndSpecial: true, isTimeline: true);

    /// <summary>
    /// 伤残
    /// </summary>
    public static BaseAction Unmend { get; } = new(ActionID.Unmend, isTimeline: true)
    {
    ...
    /// 噬魂斩
    /// </summary>
    public static BaseAction Souleater { get; } = new(ActionID.Souleater, isTimeline: true);

    /// <summary>
    /// 暗黑波动
    /// </summary>
    public static BaseAction FloodofDarkness { get; } = new(ActionID.FloodofDarkness, isTimeline: true);

    /// <summary>
    /// 暗黑锋
    /// </summary>
    public static BaseAction EdgeofDarkness { get; } = new(ActionID.EdgeofDarkness, isTimeline: true);

    /// <summary>
    /// 嗜血
    /// </summary>
    public static BaseAction BloodWeapon { get; } = new(ActionID.BloodWeapon, isTimeline: true);
    ...
    /// 腐秽大地
    /// </summary>
    public static BaseAction SaltedEarth { get; } = new(ActionID.SaltedEarth, isTimeline: true);

    /// <summary>
    /// 跳斩
    /// </summary>
    public static BaseAction Plunge { get; } = new(ActionID.Plunge, shouldEndSpecial: true, isTimeline: true)
    {
    ...
    /// 吸血深渊
    /// </summary>
    public static BaseAction AbyssalDrain { get; } = new(ActionID.AbyssalDrain, isTimeline: true);

    /// <summary>
    /// 精雕怒斩
    /// </summary>
    public static BaseAction CarveandSpit { get; } = new(ActionID.CarveandSpit, isTimeline: true);

    /// <summary>
    /// 血溅
    /// </summary>
    public static BaseAction Bloodspiller { get; } = new(ActionID.Bloodspiller, isTimeline: true)
    {
    ...
    /// 寂灭
    /// </summary>
    public static BaseAction Quietus { get; } = new(ActionID.Quietus, isTimeline: true)
    {
    ...
    /// 血乱
    /// </summary>
    public static BaseAction Delirium { get; } = new(ActionID.Delirium, isTimeline: true);
    ...
    /// 刚魂
    /// </summary>
    public static BaseAction StalwartSoul { get; } = new(ActionID.StalwartSoul, isTimeline: true);
    ...
    /// 掠影示现
    /// </summary>
    public static BaseAction LivingShadow { get; } = new(ActionID.LivingShadow, isTimeline: true)
    {
    ...
    /// 暗影使者
    /// </summary>
    public static BaseAction Shadowbringer { get; } = new(ActionID.Shadowbringer, isTimeline: true)
    {
    ...
    /// 腐秽黑暗
    /// </summary>
    public static BaseAction SaltandDarkness { get; } = new(ActionID.SaltandDarkness, isTimeline: true)
    {
