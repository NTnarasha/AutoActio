...
internal abstract class WHMCombo_Base<TCmd> : CustomCombo<TCmd> where TCmd : Enum
{
    ...
    /// 复活
    /// </summary>
    public static BaseAction Raise1 { get; } = new(ActionID.Raise1, true, isTimeline: true);
    ...
    /// 飞石 坚石 垒石 崩石 闪耀 闪灼
    /// </summary>
    public static BaseAction Stone { get; } = new(ActionID.Stone, isTimeline: true);

    /// <summary>
    /// 疾风 烈风 天辉
    /// </summary>
    public static BaseAction Aero { get; } = new(ActionID.Aero, isEot: true, isTimeline: true)
    {
    ...
    /// 神圣 豪圣
    /// </summary>
    public static BaseAction Holy { get; } = new(ActionID.Holy, isTimeline: true);

    /// <summary>
    /// 法令
    /// </summary>
    public static BaseAction Assize { get; } = new(ActionID.Assize, isTimeline: true);

    /// <summary>
    /// 苦难之心
    /// </summary>
    public static BaseAction AfflatusMisery { get; } = new(ActionID.AfflatusMisery, isTimeline: true)
    {
    ...
    /// 神速咏唱
    /// </summary>
    public static BaseAction PresenseOfMind { get; } = new(ActionID.PresenseOfMind, true, isTimeline: true)
    {
    ...
    /// 无中生有
    /// </summary>
    public static BaseAction ThinAir { get; } = new(ActionID.ThinAir, true, isTimeline: true);
