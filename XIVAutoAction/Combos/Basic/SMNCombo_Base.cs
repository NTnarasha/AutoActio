...
internal abstract class SMNCombo_Base<TCmd> : CustomCombo<TCmd> where TCmd : Enum
{
    ...
    /// 红宝石召唤 火神召唤
    /// </summary>
    public static BaseAction SummonRuby { get; } = new(ActionID.SummonRuby, isTimeline: true)
    {
    ...
    /// 黄宝石召唤 土神召唤
    /// </summary>
    public static BaseAction SummonTopaz { get; } = new(ActionID.SummonTopaz, isTimeline: true)
    {
    ...
    /// 绿宝石召唤 风神召唤
    /// </summary>
    public static BaseAction SummonEmerald { get; } = new(ActionID.SummonEmerald, isTimeline: true)
    {
    ...
    /// 宝石兽召唤
    /// </summary>
    public static BaseAction SummonCarbuncle { get; } = new(ActionID.SummonCarbuncle, isTimeline: true)
    {
    ...
    /// 宝石耀 单体
    /// </summary>
    public static BaseAction Gemshine { get; } = new(ActionID.Gemshine, isTimeline: true)
    {
    ...
    /// 宝石辉 AoE
    /// </summary>
    public static BaseAction PreciousBrilliance { get; } = new(ActionID.PreciousBrilliance, isTimeline: true)
    {
        ActionCheck = b => Attunement > 0,
    };
    ...
    /// 以太蓄能  龙神附体 
    /// </summary>
    public static BaseAction Aethercharge { get; } = new(ActionID.Aethercharge, isTimeline: true)
    {
    ...
    /// 龙神召唤 不死鸟召唤
    /// </summary>
    public static BaseAction SummonBahamut { get; } = new(ActionID.SummonBahamut, isTimeline: true)
    {
        ActionCheck = b => InCombat && HaveSummon
    };
    /// <summary>
    /// 龙神迸发 不死鸟迸发
    /// </summary>
    public static BaseAction EnkindleBahamut { get; } = new(ActionID.EnkindleBahamut, isTimeline: true)
    {
    ...
    /// 死星核爆
    /// </summary>
    public static BaseAction Deathflare { get; } = new(ActionID.Deathflare, isTimeline: true)
    {
    ...
    /// 苏生之炎
    /// </summary>
    public static BaseAction Rekindle { get; } = new(ActionID.Rekindle, true, isTimeline: true)
    {
    ...
    /// 深红旋风
    /// </summary>
    public static BaseAction CrimsonCyclone { get; } = new(ActionID.CrimsonCyclone, isTimeline: true)
    {
    ...
    /// 深红强袭
    /// </summary>
    public static BaseAction CrimsonStrike { get; } = new(ActionID.CrimsonStrike, isTimeline: true);

    /// <summary>
    /// 山崩
    /// </summary>
    public static BaseAction MountainBuster { get; } = new(ActionID.MountainBuster, isTimeline: true)
    {
    ...
    /// 螺旋气流
    /// </summary>
    public static BaseAction Slipstream { get; } = new(ActionID.Slipstream, isTimeline: true)
    {
    ...
    /// 毁灭 毁坏 毁荡
    /// </summary>
    public static BaseAction Ruin { get; } = new(ActionID.RuinSMN, isTimeline: true);

    /// <summary>
    /// 毁绝
    /// </summary>
    public static BaseAction RuinIV { get; } = new(ActionID.RuinIV, isTimeline: true)
    {
    ...
    /// 迸裂 三重灾祸
    /// </summary>
    public static BaseAction Outburst { get; } = new(ActionID.Outburst, isTimeline: true);
    ...
    /// 灼热之光 团辅
    /// </summary>
    public static BaseAction SearingLight { get; } = new(ActionID.SearingLight, true, isTimeline: true)
    {
    ...
    /// 能量吸收
    /// </summary>
    public static BaseAction EnergyDrain { get; } = new(ActionID.EnergyDrainSMN, isTimeline: true)
    {
    ...
    /// 溃烂爆发
    /// </summary>
    public static BaseAction Fester { get; } = new(ActionID.Fester, isTimeline: true)
    {
        ActionCheck = b => HasAetherflowStacks
    };
    ...
    /// 能量抽取
    /// </summary>
    public static BaseAction EnergySiphon { get; } = new(ActionID.EnergySiphon, isTimeline: true)
    {
        BuffsProvide = new[] { StatusID.FurtherRuin },
        ActionCheck = b => !HasAetherflowStacks
    };
    ...
    /// 痛苦核爆
    /// </summary>
    public static BaseAction Painflare { get; } = new(ActionID.Painflare, isTimeline: true)
    {
        ActionCheck = b => HasAetherflowStacks
    };
    #endregion
    ...
    /// 复生
    /// </summary>
    public static BaseAction Resurrection { get; } = new(ActionID.ResurrectionSMN, true, isTimeline: true);
